...
def main() -> None:
    ...
    # output_dir 为可选；默认 `${PYTHON_METAPHOR_ROOT}/mvpa_cross_phase_<ROI_SET>`，
    # 可通过环境变量 METAPHOR_MVPA_CROSS_PHASE_OUT_DIR 强制覆盖。
    ...
    if args.output_dir is None:
        ...
        args.output_dir = default_roi_tagged_out_dir(
            base_dir, "mvpa_cross_phase", override_env="METAPHOR_MVPA_CROSS_PHASE_OUT_DIR"
        )
