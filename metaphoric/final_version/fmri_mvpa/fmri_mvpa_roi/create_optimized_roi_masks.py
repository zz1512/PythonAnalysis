...
def main():
    ...
    parser.add_argument('--clusters_file', type=str, default="E:/python_metaphor/glm_analysis_fwe_final/2nd_level_CLUSTER_FWE/Metaphor_gt_Spatial/cluster_report.csv", help='Path to the clusters table CSV file.')
    parser.add_argument('--output_dir', type=str, default="E:/python_metaphor/roi_masks_final", help='Directory to save the output ROI masks.')
