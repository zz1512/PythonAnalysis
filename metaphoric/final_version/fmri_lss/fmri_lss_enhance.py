...
FMRI_TPL = r"E:/python_metaphor/Pro_proc_data/{sub}/run{run}/{sub}_task-yy_run-{run}_space-MNI152NLin6Asym_res-2_desc-preproc_bold.nii"
# 实验事件文件路径
EVENT_TPL = r"E:/python_metaphor/data_events/{sub}/{sub}_run-{run}_events.tsv"
# 头动参数文件路径
MOTION_TPL = r"E:/python_metaphor/Pro_proc_data/{sub}/multi_reg/{sub}_task-yy_run-{run}_desc-confounds_timeseries.tsv"
# 输出结果根目录
OUTPUT_ROOT = Path(r"E:/python_metaphor/lss_betas_final")
