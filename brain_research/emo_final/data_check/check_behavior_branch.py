...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--trial-beh-repr-prefix", type=str, default="behavior_patterns_trial")
    p.add_argument("--emotion-beh-repr-prefix", type=str, default="behavior_patterns_emotion4")
    p.add_argument("--trial-beh-isc-prefix", type=str, default="behavior_pattern_isc_mahalanobis_by_age")
    p.add_argument("--emotion-beh-isc-prefix", type=str, default="behavior_pattern_isc_mahalanobis_by_age")
