...
out_path='H:\metaphor\LSS\words_with_juzi\run12_with_run3';
...
for i_subj=1:nsubjects
    ...
    %%%
    Syystart=fullfile(sub_7_path,'F_yy_start_word.nii');
    ds_syystart=cosmo_fmri_dataset(Syystart,'mask',mask_fn);
 
    Syyend=fullfile(sub_7_path,'F_yy_end_word.nii');
   ...
   Skjstart=fullfile(sub_7_path,'F_kj_start_word.nii');
   ds_Skjstart=cosmo_fmri_dataset(Skjstart,'mask',mask_fn);

   Skjend=fullfile(sub_7_path,'F_kj_end_word.nii');
