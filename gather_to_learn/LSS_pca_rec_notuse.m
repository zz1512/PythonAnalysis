...
masks = {'IFG_L.nii'}; %  interesting, i found that when pcpc =3, roi = left HPC ,true memory, [r,p]=corr(yy,memory_yy,'type','Spearman'), r = 0.45, p = 0.025.   when use pcpc 35, r = 0.40, p =0.046
