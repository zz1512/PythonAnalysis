...
for s = 1:length(subjects)
    ...
    counter = counter+1;
    F_kj_word_juzi(counter,:) = allr/number;  
...
for s = 1:length(subjects)
    ...
    counter = counter+1;
    S_kj_word_juzi(counter,:) = allr/number;  
    
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[h,p,ci,stats] = ttest(F_kj_word_juzi,S_kj_word_juzi)

mean(F_kj_word_juzi)
mean(S_kj_word_juzi)

save sme_lIFG_kj_run12_run4_run56.mat F_kj_word_juzi S_kj_word_juzi
