...
for s = 1:length(subjects)
    ...
    %% 
    data_weici=fullfile(sub_path,'S_yy_juzi.nii');     %%%%%%
    ...
    counter = counter+1;
    S_yy_sword_juzi(counter,:) = allr/number;  
...
for s = 1:length(subjects)
    ...
    counter = counter+1;
    S_yy_eword_juzi(counter,:) = allr/number;  
...
for s = 1:length(subjects)
    ...
    %% 
    data_shouci=fullfile(sub_path,'S_kj_sword.nii');     %%%%%%%
    ds_shouci=cosmo_fmri_dataset(data_shouci,'mask',mask_fn);
    [number,~]=size(ds_shouci.samples);
    %% 
    data_weici=fullfile(sub_path,'S_kj_juzi.nii');     %%%%%%
    ds_weici=cosmo_fmri_dataset(data_weici,'mask',mask_fn);
    ...
    counter = counter+1;
    S_kj_sword_juzi(counter,:) = allr/number;  
...
for s = 1:length(subjects)
    ...
    %% 
    data_shouci=fullfile(sub_path,'S_kj_eword.nii');     %%%%%%%
    ds_shouci=cosmo_fmri_dataset(data_shouci,'mask',mask_fn);
    [number,~]=size(ds_shouci.samples);
    %% 
    data_weici=fullfile(sub_path,'S_kj_juzi.nii');     %%%%%%
    ...
    counter = counter+1;
    S_kj_eword_juzi(counter,:) = allr/number;  
    
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[h,p,ci,stats] = ttest(S_yy_sword_juzi,S_kj_sword_juzi)

mean(S_yy_eword_juzi)
mean(S_kj_eword_juzi)
