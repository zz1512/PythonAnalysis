...
run3_path='H:\metaphor\LSS\rsa\pattern_similarity_change_self-report_1\mvpa_pattern';  % F_yy_juzi.nii
run7_path='H:\metaphor\LSS\rsa\pattern_similarity_change_self-report_1\mvpa_pattern';   % S_yy_juzi.nii
...
for i_subj=1:nsubjects
   ...
   %all_ds_yy=cosmo_stack({all_ds_yy,ds_syyend});
    ...
    cosmo_map2fmri(result_yy, ...
        fullfile(output_path,'searchlight_yy_1.nii'));
...
for i_subj=1:nsubjects
   ...
   all_ds_kj=cosmo_stack({all_ds_kj,ds_Skjend});
    ...
    cosmo_map2fmri(r_kj, ...
        fullfile(output_path,'searchlight_kj_1.nii'));
