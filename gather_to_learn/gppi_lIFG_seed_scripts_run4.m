...
analysis_dir = 'H:\metaphor\gppi\univariate_ppi_run4';  % where ever we are pulling from
gPPI_dir     = 'H:\metaphor\gppi\lIFG_seed\output_run4';    % where ever we are outputting to
...
P.VOI           = 'H:\metaphor\mask\Reslice_IFG_L.nii'; % path to the ROI image, created above
P.Region        = 'lIFG'; % string, basename of output folder
