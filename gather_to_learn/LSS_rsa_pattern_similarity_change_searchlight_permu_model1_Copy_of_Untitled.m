...
out_path = 'H:\metaphor\LSS\rsa\pattern_similarity_change\searchlight_permu\model1';
...
for s = 1:length(subjects) 
    ...
    mask_fn = fullfile(mask_path,'Reslice_IFG_L.nii');
    ...
    cosmo_map2fmri(result, ...
        fullfile(output_path,'model1_z.nii'));
end