...
s_path = 'H:\metaphor\LSS\rsa\pattern_similarity_change_self-report_no1\mvpa_pattern';
...
for s = 1:length(subjects)
    ...
    counter = counter+1;
    my_r_first_yy(counter,:) = allr/number;  
...
for s = 1:length(subjects)
    ...
    counter = counter+1;
    my_r_second_yy(counter,:) = allr/number;  
    
end
%
 [h,p,ci,stats] = ttest(my_r_first_yy,my_r_second_yy)

mean(my_r_first_yy)
mean(my_r_second_yy)
%save my_r_second_yy_lHPC.mat my_r_second_yy_lHPC
%save my_r_first_yy_lHPC.mat my_r_first_yy_lHPC
