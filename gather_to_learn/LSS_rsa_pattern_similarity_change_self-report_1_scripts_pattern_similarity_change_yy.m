...
for s = 1:length(subjects)
    ...
    counter = counter+1;
    my_r_first_yy_lHPC(counter,:) = allr/number;  
...
for s = 1:length(subjects)
    ...
    counter = counter+1;
    my_r_second_yy_lHPC(counter,:) = allr/number;  
    
end
%
 [h,p,ci,stats] = ttest(my_r_first_yy_lHPC,my_r_second_yy_lHPC)
mean(my_r_second_yy_lHPC)
