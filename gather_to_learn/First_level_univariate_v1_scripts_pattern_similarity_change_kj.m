...
clear;clc;
subjects = {'sub-02';'sub-03';'sub-04';'sub-05';'sub-06';'sub-07';'sub-08';'sub-09';'sub-10';'sub-11';'sub-12';'sub-13';'sub-14';'sub-15';'sub-16';'sub-17';'sub-18';'sub-19';'sub-20';'sub-21';'sub-22';'sub-23';'sub-24';'sub-25';'sub-26';'sub-27';'sub-28'};
masks = {'IFG_L.nii'};
s_path = 'J:\metaphor\First_level\univariate_v1';
...
for s = 1:length(subjects)
    ...
    %% 
    data_weici=fullfile(sub_path,'con_0003.nii');     %%%%%%
...
for s = 1:length(subjects)
    ...
    %% 
    data_shouci=fullfile(sub_path,'con_0012.nii');     %%%%%%%
    ds_shouci=cosmo_fmri_dataset(data_shouci,'mask',mask_fn);
    [number,~]=size(ds_shouci.samples);
    
    %% 
    data_weici=fullfile(sub_path,'con_0013.nii');     %%%%%%
    ds_weici=cosmo_fmri_dataset(data_weici,'mask',mask_fn);
    [ds_shouci,msk]=cosmo_remove_useless_data(ds_shouci,1, 'finite');
       [ds_weici,msk]=cosmo_remove_useless_data(ds_weici,1, 'finite');
    %% hscµÄr
