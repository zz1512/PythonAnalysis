...
% nsub can not be 6 11 16 19 24
for nsub = 25:size(data_name,1)
    stage_dir = [S_dir filesep data_name(nsub).name '\run-3'];
    %%
    pattern1 = filenames(fullfile(stage_dir,'*kj_*0.0*nii'));
