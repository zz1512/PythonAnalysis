...
for s = 1:length(subjects)
    ...
    counter = counter+1;
    my_r_first_kj_lHPC(counter,:) = allr/number;  
...
for s = 1:length(subjects)
    ...
    counter = counter+1;
    my_r_second_kj_lHPC(counter,:) = allr/number;  
...
save my_r_first_kj_lHPC.mat  my_r_first_kj_lHPC
save my_r_second_kj_lHPC.mat my_r_second_kj_lHPC
