...
analysis_dir = 'H:\metaphor\gppi\univariate_ppi_run1_2';  % where ever we are pulling from
gPPI_dir     = 'H:\metaphor\gppi\output_run1_2';    % where ever we are outputting to
...
P.VOI           = 'H:\metaphor\mask\Hippocampus_L.nii'; % path to the ROI image, created above
P.Region        = 'LHIP'; % string, basename of output folder
...
P.Tasks         = {'0' 'yyw' 'kjw' 'yyew' 'kjew' 'jx' 'jc'}; % Specify the tasks for this analysis. Think of these as trial types. Zero means "does not have to occur in every session"
...
P.Contrasts(1).left      = {'yyw'}; % left side or positive side of contrast
P.Contrasts(1).right     = {'kjw'}; % right side or negative side of contrast
...
P.Contrasts(1).name      = 'yyw-kjw'; % Name of this contrast
  %prefix to the task name (optional), can be used to select each run 

P.Contrasts(2).left      = {'kjew'}; % left side or positive side of contrast
P.Contrasts(2).right     = {'yyew'}; % right side or negative side of contrast
...
P.Contrasts(2).name      = 'kjew-yyew'; % Name of this contrast


P.Contrasts(3).left      = {'yyw'};
P.Contrasts(3).right     = {'yyew'}; % right side or negative side of contrast
...
P.Contrasts(3).name      = 'yyw-yyew'; % Name of this contrast


P.Contrasts(4).left      = {'kjw'}; % left side or positive side of contrast
P.Contrasts(4).right     = {'kjew'}; % right side or negative side of contrast
...
P.Contrasts(4).name      = 'kjw-kjew'; % Name of this contrast
