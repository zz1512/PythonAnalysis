...
gPPI_dir     = 'H:\metaphor\gppi\LPCG_sphere\output_run3_Neurosynth';    % where ever we are outputting to
...
P.VOI           = 'H:\metaphor\gppi\LPCG_sphere\sphere_10--2_-62_34.nii'; % path to the ROI image, created above
