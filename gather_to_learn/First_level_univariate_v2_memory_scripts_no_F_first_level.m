...
event_dir =  'J:\metaphor\output1';

%%
for nsub = 24:length(sublist)   %
   
    event_sub_dir = [event_dir,filesep,sublist(nsub).name];
    sub_dir = [data_dir,filesep,sublist(nsub).name];
    %-----------------------------------------------------------------------
    out_dir = ['J:\metaphor\First_level\univariate_v2\',sublist(nsub).name]; 
...
%
    ...
    %%
    matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'first_time_yy_end_word_R';
    matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [0,0,0,1,0,0,zeros(1,14),0,0,0,1,0,0,zeros(1,14),zeros(1,8),zeros(1,8),zeros(1,20),zeros(1,20),zeros(1,10)];
    matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
    
    matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'first_time_yy_end_word_P';
    matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [0,0,0,0,1,0,zeros(1,14),0,0,0,0,1,0,zeros(1,14),zeros(1,8),zeros(1,8),zeros(1,20),zeros(1,20),zeros(1,10)];
   ...
   %%
    matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'second_time_yy_start_word_R';
    matlabbatch{3}.spm.stats.con.consess{5}.tcon.weights = [zeros(1,20),zeros(1,20),zeros(1,8),zeros(1,8),1,0,zeros(1,18),1,0,zeros(1,18),zeros(1,10)];
    matlabbatch{3}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
    
    matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'second_time_yy_start_word_P';
    matlabbatch{3}.spm.stats.con.consess{6}.tcon.weights = [zeros(1,20),zeros(1,20),zeros(1,8),zeros(1,8),0,1,0,zeros(1,17),0,1,0,zeros(1,17),zeros(1,10)];
    matlabbatch{3}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
    
 
    %%
    
    matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = 'second_time_yy_end_word_R';
    matlabbatch{3}.spm.stats.con.consess{7}.tcon.weights = [zeros(1,20),zeros(1,20),zeros(1,8),zeros(1,8),0,0,0,1,0,0,zeros(1,14),0,0,0,1,0,0,zeros(1,14),zeros(1,10)];
    matlabbatch{3}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
    
    matlabbatch{3}.spm.stats.con.consess{8}.tcon.name = 'second_time_yy_end_word_P';
    matlabbatch{3}.spm.stats.con.consess{8}.tcon.weights = [zeros(1,20),zeros(1,20),zeros(1,8),zeros(1,8),0,0,0,0,1,0,zeros(1,14),0,0,0,0,1,0,zeros(1,14),zeros(1,10)];
