...
for nsub = 1:length(sublist)   
    ...
    %-----------------------------------------------------------------------
    out_dir = ['H:\metaphor\gppi\univariate_ppi_run4\',sublist(nsub).name]; 
   ...
   multi_reg_path=[sub_dir,filesep,'multi_reg'];
    ...
    %%
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).scans =  cellstr(run4);
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(1).name = 'yy';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(1).onset = run4_con.onset(string(run4_con.trial_type) =='yy');
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(1).duration = 3;
   
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).name = 'kj';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).onset = run4_con.onset(string(run4_con.trial_type) =='kj');
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).duration = 3;
    
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).multi_reg ={[multi_reg_path,filesep,'multi_reg_run4.txt']};
