...
gPPI_dir     = 'H:\metaphor\gppi\rHPC_seed\output_run3';    % where ever we are outputting to
...
P.VOI           = 'H:\metaphor\mask\Hippocampus_R.nii'; % path to the ROI image, created above
P.Region        = 'rHPC'; % string, basename of output folder
