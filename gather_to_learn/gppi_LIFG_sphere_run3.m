...
gPPI_dir     = 'H:\metaphor\gppi\LIFG_sphere\output_run3';    % where ever we are outputting to
...
P.VOI           = 'H:\metaphor\gppi\LIFG_sphere\sphere_20--50_16_12.nii'; % path to the ROI image, created above
