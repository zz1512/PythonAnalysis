...
spm_jobman('initcfg');
spm('defaults', 'fMRI');
matlabbatch{1}.spm.stats.factorial_design.dir = {'H:\metaphor\cross_similarity\run3_and_run12\yy_and_kj\result'};  %%  output path
%%
data_dir = 'H:\metaphor\cross_similarity\run3_and_run12\yy_and_kj';   % con map
