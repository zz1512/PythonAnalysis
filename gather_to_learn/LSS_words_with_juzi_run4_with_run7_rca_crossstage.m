...
run4_path='H:\metaphor\LSS\rsa\pattern_similarity_change\mvpa_pattern';  % F_yy_juzi.nii
run7_path='H:\metaphor\LSS\rsa\pattern_similarity_change\mvpa_pattern';   % S_yy_juzi.nii

mask_path='H:\metaphor\LSS'; 
out_path='H:\metaphor\LSS\words_with_juzi\run4_with_run7';
...
for i_subj=1:nsubjects
    ...
    Fyy=fullfile(sub_4_path,'S_yy_juzi.nii');
    ...
    %% 
   Fkj=fullfile(sub_4_path,'S_kj_juzi.nii');
