...
clear;clc;
subjects = {'sub-01';'sub-02';'sub-03';'sub-04';'sub-05';'sub-07';'sub-08';'sub-09';'sub-10';'sub-13';'sub-14';'sub-15';'sub-16';'sub-17';'sub-18';'sub-19';'sub-21';'sub-22';'sub-24';'sub-25';'sub-27';'sub-28'};
masks = {'Hippocampus_L.nii'};% IFG_L
...
for s = 1:length(subjects)
    ...
    %% 
    data_shouci=fullfile(sub_path,'run7_kj_start_word.nii');     %%%%%%%
    ds_shouci=cosmo_fmri_dataset(data_shouci,'mask',mask_fn);
    [number,~]=size(ds_shouci.samples);
    %% 
    data_weici=fullfile(sub_path,'run7_kj_end_word.nii');     %%%%%%
    ...
    counter = counter+1;
    my_r_run7_kj(counter,:) = allr/number;  
    
end

save my_r_run7_kj_lHPC.mat my_r_run7_kj
