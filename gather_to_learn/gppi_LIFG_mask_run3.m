...
gPPI_dir     = 'H:\metaphor\gppi\LIFG_mask\output_run3';    % where ever we are outputting to
...
P.VOI           = 'H:\metaphor\gppi\LIFG_mask\sphere_10--46_38_-10.nii'; % path to the ROI image, created above
