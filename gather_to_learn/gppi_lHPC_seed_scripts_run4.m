...
gPPI_dir     = 'H:\metaphor\gppi\lPCG_seed\output_run4';     % where ever we are outputting to
...
P.VOI           = 'H:\metaphor\mask\Precuneus_L.nii'; % path to the ROI image, created above
P.Region        = 'lPCG'; % string, basename of output folder
