...
run56_path='H:\metaphor\First_level\single_trial_v1\pattern';   % S_yy_juzi.nii

mask_path='H:\metaphor\First_level\single_trial_v1'; 
out_path='H:\metaphor\cross_similarity\run3_and_run56\yy_and_kj';
...
for i_subj=1:nsubjects
    ...
    sub_56_path=fullfile(run56_path,subject_id);
    %%
    ...
    %%%
    Syystart=fullfile(sub_56_path,'S_yy_sword.nii');
    ds_syystart=cosmo_fmri_dataset(Syystart,'mask',mask_fn);
 
    Syyend=fullfile(sub_56_path,'S_yy_eword.nii');
   ...
   Skjstart=fullfile(sub_56_path,'S_kj_sword.nii');
   ds_Skjstart=cosmo_fmri_dataset(Skjstart,'mask',mask_fn);

   Skjend=fullfile(sub_56_path,'S_kj_eword.nii');
